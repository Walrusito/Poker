...
def parse_args():
    ...
    parser.add_argument("--episodes", type=int, default=2000, help="Self-play episodes per iteration")
    parser.add_argument("--eval-hands", type=int, default=5000, help="Hands to evaluate in self-play after each iteration")
    parser.add_argument("--eval-random-hands", type=int, default=0, help="Hands to evaluate against random opponents (0 = auto)")
    parser.add_argument("--eval-snapshot-hands", type=int, default=0, help="Hands to evaluate against historical snapshot opponents (0 = auto)")
    parser.add_argument("--eval-population-hands", type=int, default=0, help="Hands to evaluate against a mixed population of external historical runs (0 = auto)")
    parser.add_argument("--eval-heuristic-hands", type=int, default=0, help="Hands to evaluate against a heuristic opponent baseline (0 = auto)")
    ...
    parser.add_argument("--regret-epochs", type=int, default=4, help="Gradient epochs for the regret network per iteration")
    parser.add_argument("--policy-epochs", type=int, default=1, help="Gradient epochs for the policy network per iteration")
    ...
    parser.add_argument("--entropy-regularization", type=float, default=0.03, help="Entropy regularization weight in policy training")
